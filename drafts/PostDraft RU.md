...
- Как описано в заголовке — поддержка более 4700 символов Юникода, включая: пунктуацию, математические символы, символы валют, специальные символы, алхимические и т.д.
...
- Возможность кастомизации — от простых пользовательских раскладок, рецептов и привязок до вполне себе модификаций, позволяющих расширить доступные возможности (например, добавить новый Альтернативный режим какой-либо письменности).
